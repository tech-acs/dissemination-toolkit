...
The Dissemination Toolkit is a web platform for publishing and exploring census and survey data. It is developed and maintained by the **UN Economic Commission for Africa (ECA)**.
...
The top navigation bar provides access to the platform's core sections:

| Section | Description |
|---|---|
| **Data Explorer** | Point-and-click interface to browse, filter, pivot, and download census data |
| **Visualizations** | Browse published charts, tables, maps, and scorecards |
| **Data Stories** | Narrative-rich pages combining text, images, and embedded visualizations |
| **Documents** | Search and download census tables published as Excel files |
| **Datasets** | Browse published datasets and their metadata |
