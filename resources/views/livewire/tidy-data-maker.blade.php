<div class="p-6 max-w-7xl mx-auto space-y-6">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="space-y-6">
            <div>
                ...
                <textarea
                    ...
                    class="w-full h-48 p-3 border border-gray-300 rounded shadow-sm focus:ring focus:ring-blue-200"
            ...
            @if(count($columns) > 0)
                <div class="bg-gray-50 p-5 rounded border border-gray-200 space-y-4">
                    <div>
                        <h3 class="font-semibold text-lg text-gray-800">2. Select columns to pivot</h3>
                        <p class="text-sm text-gray-500 mb-3">Checked columns will be melted into variable/value rows. Unchecked columns remain as identifiers.</p>
                    ...
                    <div class="grid grid-cols-2 gap-4 pt-2">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Value Name</label>
        ...
        <div class="space-y-6">
            <h2 class="text-xl font-bold">3. Tidy Data Result</h2>

            @if(count($tidiedData) > 0)
                <textarea
                    readonly
                    class="w-full h-48 p-3 border border-green-300 bg-green-50 rounded shadow-sm text-sm font-mono whitespace-pre"
                >{{ $csvOutput }}</textarea>
            ...
            @else
                <div class="h-48 border-2 border-dashed border-gray-300 rounded flex items-center justify-center bg-gray-50 text-gray-400">
