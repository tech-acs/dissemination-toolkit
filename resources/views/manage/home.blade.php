                    ...
                    <li class="flow-root">
                        <div class="relative -m-2 flex items-center space-x-4 rounded-xl p-2 focus-within:ring-2 focus-within:ring-indigo-500  hover:bg-gray-50 border hover:border hover:border-blue-800">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-500">
                                    {{ __('Simplify indicator management with comprehensive capabilities. Create, update,
                ...
                <ul class="space-y-8">
                    <li class="flow-root">
                        <div class="relative -m-2 flex items-center space-x-4 rounded-xl p-2 focus-within:ring-2 focus-within:ring-indigo-500 hover:bg-gray-50 border hover:border hover:border-green-800">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-500">
                                    {{ __('Create, customize, and share interactive data visualizations. Create beautiful charts, tables, and diagrams from your data in minutes.')}}
                                </p>
                            </div>
                        </div>
                    </li>
                    <li class="flow-root">
                        <div class="relative -m-2 flex items-center space-x-4 rounded-xl p-2 focus-within:ring-2 focus-within:ring-indigo-500 hover:bg-gray-50 border hover:border hover:border-yellow-800">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-500">
                                    {{ __('Explore the data story builder to create, customize, and share captivating narratives with
                    ...
                    <li class="flow-root">
                        <div class="relative -m-2 flex items-center space-x-4 rounded-xl p-2 focus-within:ring-2 focus-within:ring-indigo-500 hover:bg-gray-50 border hover:border hover:border-sky-800">
                            ...
                            <div>
                                <h3 class="text-sm font-medium text-gray-900">
                                    <a href="{{route('manage.document.index')}}" class="focus:outline-none">
                                        <span class="absolute inset-0" aria-hidden="true"></span>
                                ...
                                <p class="mt-1 text-sm text-gray-500">
                                    ...
                                    upload tables along with metadata following the Dublin Core standard. This is the place for all your pdf reports and publications.')}}
                                </p>
                            </div>
                        </div>
                    </li>
                    <li class="flow-root">
                        <div class="relative -m-2 flex items-center space-x-4 rounded-xl p-2 focus-within:ring-2 focus-within:ring-indigo-500 hover:bg-gray-50 border hover:border hover:border-purple-800">
                            ...
                            <div>
                                <h3 class="text-sm font-medium text-gray-900">
                                    <a href="{{route('manage.tag.index')}}" class="focus:outline-none">
                                        <span class="absolute inset-0" aria-hidden="true"></span>
                                ...
                                <p class="mt-1 text-sm text-gray-500">
                                    {{ __('Tags help you categorize and filter visualizations, stories, and documents for easier
                                    discovery and organization across your dissemination platform.')}}
                                </p>
                            </div>
                        </div>
                    </li>
