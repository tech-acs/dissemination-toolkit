        ...
        <section class="shadow sm:rounded-md sm:overflow-hidden py-5 bg-white sm:p-6">
            ...
            <div class="grid grid-cols-3" style="height: calc(100vh - 360px);">
                ...
                <div class="col-span-1 border-l p-8 overflow-y-auto">
                    <livewire:table-options-shaper :options="$options" />
                </div>

            </div>

            <footer class="flex items-center justify-end gap-x-6 border-t border-gray-900/10 px-4 pt-5 sm:px-8">
                <a href="{{ route("manage.viz-builder.table.step1") }}" class="cursor-pointer rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
                    {{ __('Restart')}}
                </a>
                <a href="{{ route("manage.viz-builder.table.step3") }}" class="cursor-pointer rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                    Next
                </a>
            </footer>
