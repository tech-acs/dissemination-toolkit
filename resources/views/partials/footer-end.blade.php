    ...
    <div class="p-6 md:flex md:items-center md:justify-between border-t">
        <div class="mt-2 md:mt-0 text-center text-base text-gray-400 flex">
            ...
            <div class="flex ml-6 space-x-2">
                ...
                <div>
                    <a href="http://www.facebook.com/EconomicCommissionforAfrica" class="text-gray-400 hover:text-gray-500" target="_blank" title="{{ __('ECA on Facebook')}}">
                ...
                <div>
                    <a href="http://www.youtube.com/unecaVideo/" class="text-gray-400 hover:text-gray-500" target="_blank" title="{{ __('ECA on Youtube')}}">
                        <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <div>
                    <a href="https://twitter.com/eca_official" class="text-gray-400 hover:text-gray-500" target="_blank" title="{{ __('ECA on Twitter')}}">
                        <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
