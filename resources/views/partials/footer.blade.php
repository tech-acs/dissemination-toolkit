<footer>
    <div class="p-8 xl:px-2 bg-gray-200">
        <div class="grid max-w-screen-xl grid-cols-1 gap-10 pt-2 mx-auto lg:grid-cols-5">
            ...
            <div>
                <div>Follow us</div>
                <div class="flex mt-5 space-x-5 text-gray-400">
                    <a href="{{ $org->social_media['twitter'] ?? '' }}" target="_blank" rel="noopener">
                    ...
                    <a href="{{ $org->social_media['facebook'] ?? '' }}" target="_blank" rel="noopener">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <a href="{{ $org->social_media['instagram'] ?? '' }}" target="_blank" rel="noopener">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <a href="{{ $org->social_media['linkedin'] ?? '' }}" target="_blank" rel="noopener">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
