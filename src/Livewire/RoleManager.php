    ...
    public function mount()
    {
        ...
        $reports = [
            [
                ...
                'permissionables' => \Uneca\DisseminationToolkit\Models\Visualization::all()->map(function ($report) {
                    return [
                        'title' => $report->title,
                ...
                'count' => \Uneca\DisseminationToolkit\Models\Visualization::all()->count(),
            ]
        ];
